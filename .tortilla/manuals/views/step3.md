...
```diff
@@ -23,6 +23,7 @@
 ┊23┊23┊		"react-apollo": "^2.0.4",
 ┊24┊24┊		"react-native": "0.54.2",
 ┊25┊25┊		"react-navigation": "^1.0.3",
+┊  ┊26┊		"react-navigation-redux-helpers": "^1.0.1",
 ┊26┊27┊		"react-redux": "^5.0.5",
 ┊27┊28┊		"redux": "^3.7.2",
 ┊28┊29┊		"redux-devtools-extension": "^2.13.2"
```
...
-┊53┊  ┊    'Cmd+D or shake for dev menu',
-┊54┊  ┊  android: 'Double tap R on your keyboard to reload,\n' +
