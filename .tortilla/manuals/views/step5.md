...
#### [Step 5.1: Update Schema with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/7c0913b)
...
#### [Step 5.2: Update Resolvers with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/dab671b)
...
#### [Step 5.3: Use inverted FlatList for Messages](https://github.com/srtucker22/chatty/commit/545decc)
...
#### [Step 5.4: Update Group Query with Relay Cursor Connections](https://github.com/srtucker22/chatty/commit/7a250a3)
...
#### [Step 5.5: Add fetchMore to groupQuery](https://github.com/srtucker22/chatty/commit/a5c0e61)
...
#### [Step 5.6: Apply loadMoreEntries to onEndReached](https://github.com/srtucker22/chatty/commit/ba2a341)
...
#### [Step 5.7: Add most recent message to each Group in USER_QUERY](https://github.com/srtucker22/chatty/commit/0d7c881)
...
#### [Step 5.8: Modify Group component to include latest message](https://github.com/srtucker22/chatty/commit/a431c3f)
...
#### [Step 5.9: Manual Refresh Groups](https://github.com/srtucker22/chatty/commit/9dba5a3)
...
#### [Step 5.10: Modify createMessage mutation to update USER_QUERY](https://github.com/srtucker22/chatty/commit/99ee9bb)
...
| [< Previous Step](https://github.com/srtucker22/chatty/tree/master@3.0.0/.tortilla/manuals/views/step4.md) | [Next Step >](https://github.com/srtucker22/chatty/tree/master@3.0.0/.tortilla/manuals/views/step6.md) |
|:--------------------------------|--------------------------------:|
