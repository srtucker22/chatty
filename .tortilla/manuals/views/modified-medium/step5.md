...
#### [Step 5.1: Update Schema with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/27c8e79)
...
#### [Step 5.2: Update Resolvers with Relay Cursor Connection](https://github.com/srtucker22/chatty/commit/c0feb67)
...
#### [Step 5.3: Use inverted FlatList for Messages](https://github.com/srtucker22/chatty/commit/56efdb8)
...
#### [Step 5.4: Update Group Query with Relay Cursor Connections](https://github.com/srtucker22/chatty/commit/13b2aaf)
...
#### [Step 5.5: Add fetchMore to groupQuery](https://github.com/srtucker22/chatty/commit/c4f3efa)
...
#### [Step 5.6: Apply loadMoreEntries to onEndReached](https://github.com/srtucker22/chatty/commit/d11c40f)
...
#### [Step 5.7: Add most recent message to each Group in USER_QUERY](https://github.com/srtucker22/chatty/commit/82cbcd4)
...
#### [Step 5.8: Modify Group component to include latest message](https://github.com/srtucker22/chatty/commit/dabbbdf)
...
#### [Step 5.9: Manual Refresh Groups](https://github.com/srtucker22/chatty/commit/4ede8df)
...
#### [Step 5.10: Modify createMessage mutation to update USER_QUERY](https://github.com/srtucker22/chatty/commit/7a67059)
...
| [< Previous Step](https://github.com/srtucker22/chatty/tree/master@2.0.0/.tortilla/manuals/views/modified-medium/step4.md) | [Next Step >](https://github.com/srtucker22/chatty/tree/master@2.0.0/.tortilla/manuals/views/modified-medium/step6.md) |
|:--------------------------------|--------------------------------:|
