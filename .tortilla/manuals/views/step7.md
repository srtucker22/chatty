...
@@ -61,6 +64,21 @@
 ┊61┊64┊
 ┊62┊65┊const httpLink = createHttpLink({ uri: `http://${URL}/graphql` });
 ┊63┊66┊
...
+┊  ┊81┊
 ...
 ┊65┊83┊export const wsClient = new SubscriptionClient(`ws://${URL}/subscriptions`, {
...
-┊63┊  ┊});
-┊64┊  ┊
 ┊65┊61┊const httpLink = createHttpLink({ uri: `http://${URL}/graphql` });
 ┊66┊62┊
...
+┊   ┊102┊
 ...
 ┊ 83┊104┊export const wsClient = new SubscriptionClient(`ws://${URL}/subscriptions`, {
